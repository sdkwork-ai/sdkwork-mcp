# Runbook — sdkwork-mcp deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-mcp-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-mcp/bundle`, loads the image, starts
