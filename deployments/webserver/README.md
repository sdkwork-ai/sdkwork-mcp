...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `mcp-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `mcp-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `mcp-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `mcp-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `mcp.sdkwork.com` | 443 ssl + 80 |
